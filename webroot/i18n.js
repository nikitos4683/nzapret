...
const translations = {
    ru: {
        ...
        tg_runtime: {
            title: 'tgwsproxy',
            subtitle: 'Состояние встроенного helper-сервиса tgwsproxy внутри рантайма nzapret.',
            labels: {
                helper: 'Бинарь',
                state: 'Состояние',
                listen: 'Listen',
            ...
            helper_builtin: 'Встроен',
            helper_missing: 'Недоступен',
            running: 'В работе',
            stopped: 'Остановлен',
            missing: 'Бинарь отсутствует',
            error: 'Ошибка',
            ...
            tcp_first: 'TCP first',
            cf_auto: 'auto',
            note_initial: 'Статус tgwsproxy появится здесь после первого обновления.',
            note_missing: 'Бинарь tgwsproxy отсутствует в установленном модуле.',
            note_running: 'tgwsproxy запущен внутри общего runtime модуля.',
            note_stopped: 'tgwsproxy сейчас не запущен. Он поднимется вместе с общим стартом nzapret.'
        },
        tg_link: {
            title: 'tgwsproxy link',
            subtitle: 'Возьмите актуальную tg:// ссылку из встроенного tgwsproxy.',
            link_label: 'tg:// link',
            placeholder: 'tg://proxy?...',
            note_initial: 'Ссылка tgwsproxy появится здесь после первого обновления.',
            note_loading: 'Загружаем актуальную ссылку tgwsproxy...',
            note_ready: 'Скопируйте ссылку и откройте её для быстрого подключения прокси.',
            note_missing: 'Бинарь tgwsproxy отсутствует в установленном модуле.',
            note_error: 'Не удалось получить ссылку: {{message}}',
            reloaded: 'Ссылка tgwsproxy обновлена',
            copied: 'Ссылка tgwsproxy скопирована',
            load_failed: 'Не удалось получить ссылку tgwsproxy: {{message}}',
            copy_failed: 'Не удалось скопировать ссылку: {{message}}'
        },
        actions: {
            start: 'Старт',
            stop: 'Стоп',
    ...
    en: {
        ...
        tg_runtime: {
            title: 'tgwsproxy',
            subtitle: 'Runtime state of the built-in tgwsproxy helper service inside nzapret.',
            labels: {
                helper: 'Binary',
                state: 'State',
                listen: 'Listen',
            ...
            helper_builtin: 'Built-in',
            helper_missing: 'Unavailable',
            running: 'Running',
            stopped: 'Stopped',
            ...
            tcp_first: 'TCP first',
            cf_auto: 'auto',
            note_initial: 'tgwsproxy status will appear here after the first refresh.',
            note_missing: 'The tgwsproxy binary is missing from the installed module.',
            note_running: 'tgwsproxy is running inside the shared module runtime.',
            note_stopped: 'tgwsproxy is currently stopped. It will start with the next nzapret start.'
        },
        tg_link: {
            title: 'tgwsproxy link',
            subtitle: 'Use the current tg:// link from the built-in tgwsproxy.',
            link_label: 'tg:// link',
            placeholder: 'tg://proxy?...',
            note_initial: 'The tgwsproxy link will appear here after the first refresh.',
            note_loading: 'Loading the current tgwsproxy link...',
            note_ready: 'Copy the link and open it to attach the proxy quickly.',
            note_missing: 'The tgwsproxy binary is missing from the installed module.',
            note_error: 'Failed to load the link: {{message}}',
            reloaded: 'tgwsproxy link refreshed',
            copied: 'tgwsproxy link copied',
            load_failed: 'Failed to load tgwsproxy link: {{message}}',
            copy_failed: 'Failed to copy the link: {{message}}'
        },
        actions: {
            start: 'Start',
            stop: 'Stop',
